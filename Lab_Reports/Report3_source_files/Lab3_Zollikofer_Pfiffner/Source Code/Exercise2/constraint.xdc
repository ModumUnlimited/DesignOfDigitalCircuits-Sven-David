...
# choose the right 7 segment display:
...
# display chooser logic:

set_property PACKAGE_PIN W14 [get_ports {chooser[0]}]					
	set_property IOSTANDARD LVCMOS33 [get_ports {chooser[0]}]
set_property PACKAGE_PIN W13 [get_ports {chooser[1]}]					
	set_property IOSTANDARD LVCMOS33 [get_ports {chooser[1]}]