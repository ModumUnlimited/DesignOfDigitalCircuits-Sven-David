...
set_property PACKAGE_PIN T2 [get_ports {dispCon[1]}]
    set_property IOSTANDARD LVCMOS33 [get_ports {dispCon[1]}]
set_property PACKAGE_PIN T3 [get_ports {dispCon[0]}]
    set_property IOSTANDARD LVCMOS33 [get_ports {dispCon[0]}]