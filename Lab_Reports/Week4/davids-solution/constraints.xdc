...
set_property PACKAGE_PIN W3 [get_ports {leds2[0]}]					
	set_property IOSTANDARD LVCMOS33 [get_ports {leds2[0]}]
set_property PACKAGE_PIN U3 [get_ports {leds2[1]}]					
	set_property IOSTANDARD LVCMOS33 [get_ports {leds2[1]}]
set_property PACKAGE_PIN P3 [get_ports {leds2[2]}]					
	set_property IOSTANDARD LVCMOS33 [get_ports {leds2[2]}]
set_property PACKAGE_PIN N3 [get_ports {leds2[3]}]					
	set_property IOSTANDARD LVCMOS33 [get_ports {leds2[3]}]
set_property PACKAGE_PIN P1 [get_ports {leds2[4]}]					
	set_property IOSTANDARD LVCMOS33 [get_ports {leds2[4]}]
set_property PACKAGE_PIN L1 [get_ports {leds2[5]}]					
