...
set_property PACKAGE_PIN W3 [get_ports {LC}]					
	set_property IOSTANDARD LVCMOS33 [get_ports {LC}]
set_property PACKAGE_PIN U3 [get_ports {LB}]					
	set_property IOSTANDARD LVCMOS33 [get_ports {LB}]
set_property PACKAGE_PIN P3 [get_ports {LA}]					
	set_property IOSTANDARD LVCMOS33 [get_ports {LA}]
set_property PACKAGE_PIN N3 [get_ports {RA}]					
	set_property IOSTANDARD LVCMOS33 [get_ports {RA}]
set_property PACKAGE_PIN P1 [get_ports {RB}]					
	set_property IOSTANDARD LVCMOS33 [get_ports {RB}]
set_property PACKAGE_PIN L1 [get_ports {RC}]					
