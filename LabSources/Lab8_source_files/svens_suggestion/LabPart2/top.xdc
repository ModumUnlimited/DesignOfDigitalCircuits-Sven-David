...
# Input port to read the switch value for speed control of the snake
set_property PACKAGE_PIN V17 [get_ports SPEEDSWITCHES[0]]
# SPEEDSWITCHES1
set_property PACKAGE_PIN V16 [get_ports SPEEDSWITCHES[1]]
# SPEEDSWITCHES1
set_property IOSTANDARD LVCMOS33 [get_ports SPEEDSWITCHES]
